#!/bin/ksh
# This script was generated Mon Mar 29 12:04:25 2021 by:
#
...
#	/home/ec03/Desktop/01JST18EC055/nand.xcn -assura_run_dir \
#	/home/ec03/Desktop/01JST18EC055 -assura_run_name nand -rcxdir \
#	/home/ec03/Desktop/01JST18EC055/nand -xy_coordinates c,r -type full \
#	-temperature 25.0 -tempdir \
#	/home/ec03/Desktop/01JST18EC055/nand/rcx_temp -sub_node_char # \
...
#	-output /home/ec03/Desktop/01JST18EC055/nand/extview.tmp \
...
##RC_FREQUENCY=
##RCXDIR=/home/ec03/Desktop/01JST18EC055/nand
##RCXFS_HIGH=N
...
##TEMPDIR=/home/ec03/Desktop/01JST18EC055/nand/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
TEMPDIR=`setTempDir /home/ec03/Desktop/01JST18EC055/nand/rcx_temp`
export TEMPDIR
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/ec03/Desktop/01JST18EC055/nand
...
/home/ec03/Desktop/01JST18EC055/nand.xcn
ENDCAT
...
export GOALIE2DIR
vdbToRcx /home/ec03/Desktop/01JST18EC055 nand -unit meters -mFactorR -- -V1 \
	-H satfile -r /home/ec03/Desktop/01JST18EC055/nand.xcn -df2 -xgl
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -cgnd ${CAP_GROUND},1.0 -sc \
	...
	- NET - /home/ec03/Desktop/01JST18EC055/nand/extview.tmp
